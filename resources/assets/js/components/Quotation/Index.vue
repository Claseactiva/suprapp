            ...
            <div class="table-list-toolbar">
                <div class="table-list-toolbar__rows">
                    ...
                    <select class="custom-select custom-select-sm" v-model.number="pagination.per_page"
                        @change="getPendingQuotations({ page: 1, per_page: pagination.per_page })">
                ...
                <ul class="pagination">
                    <li class="page-item" v-if="pagination.current_page > 1">
                        <a class="page-link border-light bg-dark" href="#" @click.prevent="changePageQuotation({page: 1, per_page: pagination.per_page})">
                            <span>Primera</span>
                        </a>
                    </li>

                    <li class="page-item" v-if="pagination.current_page > 1">
                        <a class="page-link border-light bg-dark" href="#" @click.prevent="changePageQuotation({page: pagination.current_page - 1, per_page: pagination.per_page})">
                            <span>Atrás</span>
                        </a>
                    </li>
                    ...
                    <li class="page-item" v-for="page in pagesNumber"
                        ...
                        <a class="page-link border-light bg-dark" href="#" @click.prevent="changePageQuotation({page, per_page: pagination.per_page})">
                            {{ page }}
                        </a>
                    </li>
                    ...
                    <li class="page-item" v-if="pagination.current_page < pagination.last_page">
                        <a class="page-link border-light bg-dark" href="#"  @click.prevent="changePageQuotation({page:pagination.last_page, per_page: pagination.per_page})">
                            <span>Última</span>
                        </a>
                    </li>
                </ul>
...
export default {
    ...
    methods:{
        ...mapActions(['getPendingQuotations', 'createQuotation', 'showModalDetail', 'modalCreateUserFromQuotation', 'changePageQuotation'])
    },
    created(){
        loadProgressBar();
