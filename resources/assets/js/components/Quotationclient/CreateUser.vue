                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input v-validate="'required|min:6'"
                            :class="{ 'input': true, 'is-invalid': errors.has('email') }" type="email" name="email"
                        ...
                        <input v-validate="'required'" :class="{ 'input': true, 'is-invalid': errors.has('password') }"
                            type="password" name="password" class="form-control" v-model="newUser.password">
