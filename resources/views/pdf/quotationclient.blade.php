...
@section('content')
    <div>
        ...
        <p class="text-right bold font-size">Neto: $ {{ $totalServicio }}</p>
        <p class="text-right bold font-size">IVA: $ {{ ceil(($totalServicio * 0.19) / 10) * 10 }}</p>
        <p class="text-right bold font-size">Total: $ {{ ceil(($totalServicio * 1.19) / 10) * 10 }}</p>
